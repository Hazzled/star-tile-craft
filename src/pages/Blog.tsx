        ...
        <article className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-semibold mb-6">1. The Tile Itself: Material Costs</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Ceramic: The Budget-Friendly Workhorse</h4>
                    <p>Perfect for most applications, ceramic offers excellent value and comes in countless styles. Ideal for Portland homes seeking quality without premium pricing.</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Porcelain: Mid-Range Durability</h4>
                    <p>Extremely durable and water-resistant, making it perfect for Portland's damp climate. Excellent for bathrooms and high-traffic areas.</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Natural Stone (Marble, Travertine, Slate)</h4>
                    <p>Higher-end materials that bring unique beauty and character. Requires specialized installation and ongoing maintenance.</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Artisan/Handmade Tile</h4>
                    <p>Premium option for homeowners wanting a unique, "Keep Portland Weird" aesthetic that reflects the city's creative spirit.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-semibold mb-6">2. Project Size & Complexity</h3>
                <p className="mb-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p>Straightforward kitchen backsplashes or rectangular floor layouts with minimal cuts and standard patterns.</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Complex Projects</h4>
                    <p>Custom shower niches, intricate patterns like herringbone or mosaic, numerous detailed cuts, or leveling uneven floors in older Portland homes. These require advanced skills and additional time.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-semibold mb-6">3. Labor & Preparation: The Most Crucial Factor</h3>
                <p className="mb-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p>Safely removing existing materials and preparing the workspace.</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Surface Preparation</h4>
                    <p>Ensuring surfaces are perfectly flat, stable, and ready for long-lasting installation.</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Waterproofing</h4>
                    <p>Critical for Portland bathrooms. We use proven systems like Schluter-Kerdi to protect against moisture damage in our climate.</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium text-primary mb-2">Expert Installation & Finishing</h4>
                    <p>Precise tile placement, professional grouting, and sealing for lasting beauty and performance.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-semibold mb-6">4. Your Home's Unique Character</h3>
                <p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-4">Kitchen Backsplash</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-4">Bathroom Floor</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-4">Walk-in Shower</h3>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-4">Tip 1: Select Your Tile Early</h3>
                  <p>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-4">Tip 2: Factor in a Contingency</h3>
                  <p>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-4">Tip 3: Understand Where Not to Skimp</h3>
                  <p>
          ...
          <section className="mb-12">
            <Card className="bg-primary/5 border-primary/20">
              <CardContent className="p-8 text-center">
                <h2 className="text-3xl font-bold mb-6">Ready to Start Your Portland Tile Project?</h2>
                <p className="text-lg mb-8">
                ...
                <Button size="lg" className="mb-4">
                  <Link to="/contact" className="text-background">
