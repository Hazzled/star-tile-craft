      ...
      <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          <Button 
            ...
            aria-label="Get a free tile installation quote"
          >
            Get a Free Quote
          ...
          <Link to="/about">
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-navy px-8 py-4 text-lg rounded-xl transition-all duration-300"
            >
              Learn About Us
            </Button>
          </Link>
